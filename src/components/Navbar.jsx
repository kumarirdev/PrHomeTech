...
import { Building2, Wrench, Phone, House, } from "lucide-react";
...
function Navbar() {
  ...
  return (
    <>
      <div className="w-full h-[73px] border-b border-gray-300 px-15 backdrop-blur-3xl z-50 flex items-center justify-between sticky top-0 bg-white">
